...
class SOAppliance(ApplianceData):
    ...
    def get_cavity_supported_min_temp(self, cavity, program: str = None) -> float:
    ...
    def get_cavity_supported_max_temp(self, cavity, program: str = None) -> float:
        """Return the maximum cavity supported temperature."""
        current_program = program if program is not None else self.get_current_cavity_program(cavity)
        return self._config.get_cavity_temperature_range(cavity, current_program,
                                                         self.state.properties.get(REPORTED)).get(MAX)

    def get_cavity_supported_step_temp(self, cavity, program: str = None) -> float:
        """Return the cavity step increment for temperature control."""
        current_program = program if program is not None else self.get_current_cavity_program(cavity)
        return self._config.get_cavity_temperature_range(cavity, current_program,
                                                         self.state.properties.get(REPORTED)).get(STEP)

    def get_cavity_supported_min_duration(self, cavity, program: str = None) -> float:
    ...
    def get_cavity_supported_max_duration(self, cavity, program: str = None) -> float:
    ...
    def get_cavity_supported_step_duration(self, cavity, program: str = None) -> float:
    ...
    def get_current_cavity_program(self, cavity) -> str:
    ...
    def get_current_cavity_target_temperature_c(self, cavity) -> float:
    ...
    def get_current_cavity_target_temperature_f(self, cavity) -> float:
    ...
    def get_current_cavity_display_temperature_c(self, cavity) -> float:
    ...
    def get_current_cavity_display_temperature_f(self, cavity) -> float:
    ...
    def get_current_cavity_appliance_state(self, cavity) -> str:
    ...
    def get_current_cavity_door_state(self, cavity) -> str:
    ...
    def get_current_cavity_running_time(self, cavity) -> int:
    ...
    def get_current_cavity_time_to_end(self, cavity) -> int:
    ...
    def get_current_cavity_target_duration(self, cavity) -> int:
    ...
    def get_current_cavity_start_at(self, cavity) -> datetime:
    ...
    def get_current_cavity_cavity_light(self, cavity) -> bool:
    ...
    def get_current_cavity_food_probe_insertion_state(self, cavity) -> str:
    ...
    def get_current_cavity_display_food_probe_temperature_f(self, cavity) -> float:
    ...
    def get_current_cavity_display_food_probe_temperature_c(self, cavity) -> float:
    ...
    def get_temperature_f_command(self, cavity, temperature) -> dict[str, Any]:
    ...
    def get_target_duration_command(self, cavity, duration_sec: int) -> dict[str, Any]:
